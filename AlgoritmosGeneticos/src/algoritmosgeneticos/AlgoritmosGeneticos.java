...
public class AlgoritmosGeneticos {
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        Seleccion seleccionar = new SeleccionMixta(new SeleccionRuleta(), new SeleccionElite(), 0.8, 30); // N is the total number of chromosomes. gap is a parameter between 0 and 1.
